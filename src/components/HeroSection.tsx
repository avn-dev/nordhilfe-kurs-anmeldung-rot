            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6" role="list" aria-label="Kurs-Vorteile">
              <div className="text-center" role="listitem">
                <div className="bg-white p-3 rounded-full w-16 h-16 mx-auto mb-3 flex items-center justify-center shadow-md">
                  <Heart className="h-8 w-8 text-primary-500" aria-hidden="true" />
                </div>
                <p className="text-xs md:text-sm font-semibold text-gray-700 px-1">Lebensrettend</p>
              </div>
              <div className="text-center" role="listitem">
                <div className="bg-white p-3 rounded-full w-16 h-16 mx-auto mb-3 flex items-center justify-center shadow-md">
                  <Shield className="h-8 w-8 text-primary-500" aria-hidden="true" />
                </div>
                <p className="text-xs md:text-sm font-semibold text-gray-700 px-1">Zertifiziert</p>
              </div>
              <div className="text-center" role="listitem">
                <div className="bg-white p-3 rounded-full w-16 h-16 mx-auto mb-3 flex items-center justify-center shadow-md">
                  <Award className="h-8 w-8 text-primary-500" aria-hidden="true" />
                </div>
